...
export interface FormControlValues {
  ...
  type: 'text' | 'number' | 'password' | 'email' | 'select' | 'textarea' | 'datalist';
  name: string;
  label: string;
  selectValues?: string[];
  list?: string;
...
export interface ONGVolunteerFormValues {
  [key: string]: FormControlValues,
}

export type ONGVolunteerFormValuesKeys = keyof ONGVolunteerFormValues;
...
export const ONG_FORM_VALUES: ONGVolunteerFormValues = {
  CIF: {
    type: 'text',
    name: 'cif',
    label: 'CIF',
...
export const VOLUNTEER_FORM_VALUES: ONGVolunteerFormValues = {
  NIF: {
    type: 'text',
    name: 'nif',
    label: 'NIF',
...
export const ACTIVITIE_FORM_VALUES: ONGVolunteerFormValues = {
  NAME: {
    type: 'text',
    name: 'nombre',
    label: 'Nombre',
